  ...
  -----------
	...
	Asm.Apolo.Dom Componente de Framework Apolo es un 
	componente que ofrece clases que definen el contrato 
	para una implementacion de repository, unit of work, 
	entity, etc. Debe ser referenciado en la capa de 
	dominio bajo una arquitectura domain driven design.
  ...
  ------------------
	...
	https://github.com/uibasoft/asmapolo/releases
  ...
  -------------
	...
	https://github.com/uibasoft/asmapolo/wiki
  ...
  ---------
	...
	Copyright (c) 2017 Uibasoft - Asm.Apolo.Dom
  ...
  ---------
     ...
     o Si va informarnos de nuevas versiones de codigo
	   ...
	   sobre Asm.Apolo.Core, puedes registrar tu comentario en:

       https://github.com/uibasoft/asmapolo/issues
     ...
     o Si quieres participar en el desarrollo de mejoras o
	   ...
	   https://github.com/uibasoft/asmapolo/graphs/contributors
