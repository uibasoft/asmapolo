  ...
  -----------
	...
	Asm.Apolo.Core Componente de Framework Apolo es un 
	componente que ofrece clases de resultado de comunicacion 
	entre métodos, extension, utils, etc. El cual permite retornar 
	los errores que se producen durante el desarrollo del proceso.
  ...
  ---------
	...
	Copyright (c) 2017 Uibasoft - Asm.Apolo.Core
